...
module Functions (F : Ctypes.FOREIGN) = struct
  ...
  let unregister_handler =
    foreign
      "monome_unregister_handler"
      (ptr Types.monome @-> Types.event_t @-> returning int)
  ;;
  ...
  let handle_next = foreign "monome_event_handle_next" (ptr Types.monome @-> returning int)
  ...
  let set_led =
    foreign
      "monome_led_set"
      (ptr Types.monome @-> uint @-> uint @-> uint @-> returning int)
  ;;
  ...
  let map_led =
    foreign
      "monome_led_map"
      (ptr Types.monome @-> uint @-> uint @-> ptr (const uint8_t) @-> returning int)
  ;;
